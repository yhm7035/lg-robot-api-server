import { GetOperation, SetOperationType, GetOperationType, GetInput, TransactionInput, ValueOnlyTransactionInput, SetMultiTransactionInput, EvalRuleInput, EvalOwnerInput, MatchInput } from '../types';
import Ain from '../ain';
export default class Reference {
     ...
     * @param path
     */
    getValue(input: GetInput): Promise<any>;
    /**
     * Returns the rule at the path.
     * @param path
     */
    getRule(input: GetInput): Promise<any>;
    /**
     * Returns the owner config at the path.
     * @param path
     */
    getOwner(input: GetInput): Promise<any>;
    /**
     * Returns the function config at the path.
     * @param path
     */
    getFunction(input: GetInput): Promise<any>;
    /**
     ...
     * @param is_global
     */
    static buildGetRequest(type: GetOperationType, ref: string, is_global?: boolean): {
