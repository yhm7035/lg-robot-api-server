...
var Reference = /** @class */ (function () {
     ...
     * @param path
     */
    Reference.prototype.getValue = function (path) {
        var req = Reference.buildGetRequest('GET_VALUE', Reference.extendPath(this.path, path));
     ...
     * @param path
     */
    Reference.prototype.getRule = function (path) {
        var req = Reference.buildGetRequest('GET_RULE', Reference.extendPath(this.path, path));
        return this._ain.provider.send('ain_get', req);
    };
    /**
     ...
     * @param path
     */
    Reference.prototype.getOwner = function (path) {
        var req = Reference.buildGetRequest('GET_OWNER', Reference.extendPath(this.path, path));
        return this._ain.provider.send('ain_get', req);
    };
    /**
     ...
     * @param path
     */
    Reference.prototype.getFunction = function (path) {
        var req = Reference.buildGetRequest('GET_FUNCTION', Reference.extendPath(this.path, path));
        return this._ain.provider.send('ain_get', req);
    };
    /**
     ...
     * @param ref
     */
    Reference.buildGetRequest = function (type, ref) {
    ...
    Reference.extendSetTransactionInput = function (input, ref, type) {
        var operation = { type: type, ref: ref, value: input.value };
        delete input.value;
